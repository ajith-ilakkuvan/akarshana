...
export const locations: LocationSummary[] = [
  ...
  },
  {
    ...
    branch: {
      ...
      postalCode: "642126",
      gallery: [
        { src: "/gallery/udumalpet/1.webp", alt: "Akarshana Gold Company Udumalpet branch signage and counter" },
        { src: "/gallery/udumalpet/2.webp", alt: "Akarshana Gold Company Udumalpet branch front entrance" },
        { src: "/gallery/udumalpet/3.webp", alt: "Akarshana Gold Company Udumalpet branch main signboard close-up" },
        { src: "/gallery/udumalpet/4.webp", alt: "Akarshana Gold Company Udumalpet branch reception counter" },
        { src: "/gallery/udumalpet/5.webp", alt: "Akarshana Gold Company Udumalpet branch interior" },
        { src: "/gallery/udumalpet/6.webp", alt: "Akarshana Gold Company Udumalpet branch counter and seating" },
        { src: "/gallery/udumalpet/7.webp", alt: "Akarshana Gold Company Udumalpet branch signboard" },
        { src: "/gallery/udumalpet/8.webp", alt: "Akarshana Gold Company Udumalpet branch entrance and counter" },
        { src: "/gallery/udumalpet/9.webp", alt: "Akarshana Gold Company Udumalpet branch balcony view" },
      ],
