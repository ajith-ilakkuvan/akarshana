...
import { setGlowPosition } from "@/lib/goldGlow";
...
export function ServiceCard({ service }: { service: ServiceItem }) {
  ...
  return (
    <article
      onPointerEnter={setGlowPosition}
      onPointerMove={setGlowPosition}
      className="gold-glow-hover flex h-full flex-col rounded-2xl border border-charcoal/10 bg-white p-6 transition-shadow hover:shadow-lg"
    >
      <span aria-hidden="true" className="gold-glow-hover__layer" />
